...
public class Classifier_st_Up {
    private static final String MODEL_NAME = "Stretching_Up.tflite";
    private static final String LABEL_FILE = "Stretching_Up_labels.txt";
    ...
    public Classifier_st_Up(Context context) {
